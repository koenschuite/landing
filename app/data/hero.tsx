...
export default function Heros() {
  return (
    <main className="m-48 grid grid-cols-2">
        <div className="col-span-1">
            <h5 className="uppercase tracking-wider font-light font-md text-gray-100">What is data control?</h5>
            <h2 className="font-medium text-white text-4xl tracking-widest leading-relaxed mt-2">
                The Future of Sharing <br />
                Data with the World
            </h2>
            
            <div className="text-gray-300 tracking-wider leading-relaxed font-light  border-l-2 m-12 pl-12 ">
